...
import kr.ac.cau.cse.caunter2015.RegisterActivity;
...
public class DateTabActivity extends Activity {
    ...
    private class ListViewItemClickListener implements android.widget.AdapterView.OnItemClickListener {
        ...
        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
            Intent intent = new Intent(DateTabActivity.this, RegisterActivity.class);
            intent.putExtra("Event",DateTabActivity.this.eventList.get(position).getEventID());
